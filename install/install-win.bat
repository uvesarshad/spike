...
REM   2. Installs the qa CLI globally from npm (spike-agent).
REM   3. Registers "spike daemon" to auto-start on login (Scheduled Task) and starts
...
call spike daemon --install-service
if errorlevel 1 (
